...
<template>
    <v-card>
        ...
        <v-card-item v-if="start">
            ...
            <v-card-action>
                <v-btn @click="showname = true; start = false">Начать</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showname">
            ...
            <v-card-action>
                ...
                <v-btn @click="showgender = true; showname = false">Продолжить</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showgender">
            ...
            <v-card-action>
                ...
                <v-btn @click="showage = true; showgender = false">Продолжить</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showage">
            ...
            <v-card-action>
                <v-btn @click="showweight = true; showage = false">Продолжить</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showweight">
            ...
            <v-card-action>
                ...
                <v-btn @click="showheight = true; showweight = false">Продолжить</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showheight">
            ...
            <v-card-action>
                ...
                <v-btn @click="showactivity = true; showheight = false">Продолжить</v-btn>
            </v-card-action>
        </v-card-item>
        ...
        <v-card-item v-if="showactivity">
            ...
            <v-btn @click="showname = true; showactivity = false">Начать заново</v-btn>
        </v-card-item>

<!-- Results display -->
<v-card-item v-for="user in UserStore.user" :key="user.id">
    {{ user.uname }}, ваша суточная норма калорий равна {{ calculateCalories(user) }}
</v-card-item>
</v-card>
<Navigation/>
</template>
